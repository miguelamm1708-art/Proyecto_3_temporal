...
const playableElements = document.querySelectorAll('.albunes, .canciones');
...
function loadSong(albumElement) {
    ...
    const title = albumElement.querySelector('.text').innerText;
    const artist = albumElement.querySelectorAll('.text')[1].innerText;
